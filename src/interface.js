  ...
  const renderProjects = (projects) => {
    projects.forEach(function (project, index, array) {
      ...
      if (index === array.length - 1) {
        ...
        addHover(
          deleteButton,
          createHoverDiv("deleteHover", "Delete this project", titleDiv)
        );
        addHover(
          addTaskButton,
          createHoverDiv("addTaskHover", "Add a new task", titleDiv)
        );
        addHover(
          showTasksButton,
          createHoverDiv("showTasksHover", "Show all tasks", titleDiv)
        );
      }
    });
  };
